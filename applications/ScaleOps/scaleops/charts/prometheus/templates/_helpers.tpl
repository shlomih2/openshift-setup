...
{{/*
Create a fully qualified ClusterRole and Role name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
...
{{- define ".prometheus.internalRoleName" -}}
{{- if .Values.server.internalRoleNameOverride -}}
{{ .Values.server.internalRoleNameOverride | trunc 63 | trimSuffix "-" }}
{{- else -}}
{{ include "prometheus.server.fullname" . }}-internal
{{- end -}}
{{- end -}}
